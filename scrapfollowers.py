...
def scrape():
    usr = input('[Required] - Masukan Nama Instagram Yang Ingin Discraping: ')

    user_input = int(
        input('[Required] - Berapa Username & Follower Yang ingin Discrap (10-500 rekomendasi): '))
    ...
    print('[Info] - Sedang Scraping Nich Sabar Ya !!...')
    ...
    print('[Info] - Sedang Menyimpan Data Scrapping...')
    print('[DONE] - Sudah Selesai Nich Data Disimpan Pada.csv file!')

    with open('Data Followers.csv', 'a') as file:
        file.write('\n'.join(users) + "\n")
